            ...
            builder: (context, state) {
              if (state is TerraceLoaded && state.hasUnsavedChanges) {
                return Row(
                  children: [
                    TextButton.icon(
                      onPressed: () => context.read<TerraceBloc>().add(ResetLayout()),
                      icon: const Icon(Icons.undo, color: Colors.white),
                      label: const Text('Reset', style: TextStyle(color: Colors.white)),
                    ),
                    TextButton.icon(
                      onPressed: () => context.read<TerraceBloc>().add(SaveLayout()),
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    // Render all terraces
                    ...state.terraces.map((terrace) => _buildDraggableTerrace(context, terrace)),
                  ],
                ),
              ),
            );
